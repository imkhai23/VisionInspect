-- ============================================================
-- VisionInspect — Script 01: Tao bang Database (Day du)
-- Mon: Cac cong nghe moi trong phat trien phan mem
-- Huong dan: Chay file nay tren Supabase SQL Editor
-- Bao gom: 10 bang chinh + Triggers + RLS + Indexes
-- ============================================================
-- Danh sach bang:
--  1. public.users            (Nguoi dung)
--  2. public.predictions      (Ket qua phan tich AI)
--  3. public.subscriptions    (Goi dang ky)
--  4. public.usage_logs       (Nhat ky su dung)
--  5. public.datasets         (Bo du lieu AI)
--  6. public.dataset_assets   (File anh trong dataset)
--  7. public.training_jobs    (Cong viec huan luyen AI)
--  8. public.training_logs    (Nhat ky huan luyen)
--  9. public.model_versions   (Phien ban mo hinh AI)
-- 10. public.deployed_models  (Lich su trien khai model)
-- ============================================================
